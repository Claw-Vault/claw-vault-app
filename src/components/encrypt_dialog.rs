                    ...
                    div { class: "flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0",
                        div {
                            ...
                            match data() {
                                Ok(op_data) => {
                                    match op_data {
                                        Some(EncryptResponse { id, key, valid_for }) => rsx !{
                                            div {
                                                class: "flex flex-col",
                                                id: "modal-data",
                                                ...
                                                div { class: "mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3",
                                                    button {
                                                        ...
                                                        onclick: move |_| async move {
                                                            ...
                                                            let _ = web_sys::window().unwrap().navigator().clipboard().write_text(format!("{}.{}", data.id, data.key).as_str());
                                                            show.set(false);
                                                        },
                                                        r#type: "button",
                                                        svg {
