...
pub fn Navbar() -> Element {
    ...
    rsx! {
        nav { class: "sticky absolute inset-x-0 top-0 z-30",
            div { class: "flex items-center justify-between p-4 lg:px-8 text-dark-brand bg-white shadow-sm",
                ...
                div { class: "flex md:hidden",
                    button { r#type: "button", class: "-m-2.5 inline-flex items-center justify-center rounded-md p-2.5",
                        onclick: move |_| async move {
                            show_mobile_nav.set(true);
                        },

                        svg { class: "size-6 stroke-dark-brand", fill: "none", view_box: "0 0 24 24", stroke_width: "1.5",
                ...
                div { class: "hidden md:flex md:gap-x-12 md:justify-end",
                    a { href: GITHUB_URL, target: "_blank", class: "text-md font-semibold leading-6",
                        "Github"
                    }
            ...
            if show_mobile_nav() {
                div { class: "fixed top-0 z-30 w-full overflow-y-auto bg-zinc-800 text-zinc-300 p-4 sm:max-w-sm",
                    div { class: "flex items-center justify-between",
                        div { class: "flex lg:flex-1 flex-row items-center",
                            a { class: "flex items-center", href: "/",
                                img { class: "size-12 mr-4", src: FAVICON_PNG }
                                p { class: "text-lg font-semibold text-brand", "ClawVault" }
                            }
                        }
